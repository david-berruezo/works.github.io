function MenuContentBusiness() {
    
    var _instance = document.createElement("div");
    _instance.setAttribute("name","menu_content_business");
    _instance.style.position = "absolute";
    _instance.style.backgroundColor = UIColors.FONT_DARK;
    var _selector, _social, _contact, _footer, _menuData, _guides, _width = 0,_isOpen = (MainMenu.CLOSED, !1);
