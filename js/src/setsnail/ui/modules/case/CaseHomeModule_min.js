function CaseHomeModule(data, infoData, onArrowClick) {
    ...
    _instance.setAttribute("name","case_home_module");
    ...
    function addDetails() {
        ...
        _details.setAttribute("name","details");
    ...
    function addName() {
        ...
        _name.setAttribute("name","textarea");
    ...
    function addCaseInfo() {
        ...
        _case.setAttribute("name","case_small_info");
    ...
    function addFooter() {
        ...
        _footer.setAttribute("name","footer");
