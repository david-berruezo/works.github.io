	...
	<body>
		...
		<div style='display: none;' id='content'>
                  ...
                  <!-- <div data-path='royalpasseigdegraciahotel' data-template="case-0"> -->
                    ...
                    <div data-name="home">
                        ...
                        <div data-name="details">
                            ...
                            Website: <a target="_blank" href="https://davidberruezo.com/hostalparisbcn">https://davidberruezo.com/hostalparisbcn</a> 
                           </div>
                        </div>
                        <div data-name="body">
            ...
            <div data-path='projectsecommerce' data-template="projectsecommerce">
                ...
                <div data-path='box34' data-template="case-0">
                    ...
                    <div data-name="info">
                        ...
                        <div data-name="website"><a target="_blank" href="https://taller.concesionariobox34.com">Box34 | Peugeot</a></div>
                    </div>

                    <div data-name="overviewimage">
                        <?php echo $url; ?>upload/box34/plantilla_1.png
                    </div>
                    ...
                    <div data-name="home">
                        ...
                        <div data-name="details">
                            <div>
                                <br />
                                Server Languages:&nbsp; PHP, CodeIgniter, MySQL<br />
                                Client Languages: Javascript, jQuuery<br />
                                Database:&nbsp; MySQL<br />
                                Animations:&nbsp; Tween<br />
                                Credits: <b>Box34 | Peugoeot</b><br>
                                Website: <a target="_blank" href="https://taller.concesionariobox34.com">https://taller.concesionariobox34.com</a>
                            </div>
                        </div>
                        <div data-name="body">
                            <p><b>Incidence managament&nbsp;</b>to relation clients, mechanical workshop, vehicles and incidences</p>
                        </div>
                    </div>
                    ...
                    <div data-name="modules">
                        ...
                        <div data-name="moduleText">
                            <div data-name="top">
                                <p>
                                    <b>Box34 | Peugeot</b>
                                    <br>
                                    Managament Incidence
                                    <br>
                                    mechanical workshop, Clients, Vehicles , Incidences
                                    <br>
                                    Status Incidence and Emails
                                </p>
                            </div>
                        </div>

                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/box34/plantilla_2.png
                        </div>
                        ...
                        <div data-name="moduleText">
                            <div data-name="top">
                                <p>
                                    <b>3 Profiles</b>
                                    <br>
                                    Superadmin | Mechanical Workshop | Clients
                                    <br>
                                    Relation Database: Mulitple Mechanical Workshop and multiple Clients
                                    <br>
                                    Relation Database: One Client and multiple Vehciles
                                    <br>
                                    Relation Database: One Client and multiple Incidence
                                    <br>
                                    Customitzation profiles Superadmin | Mechanical Workshop | Clients
                                </p>
                            </div>
                        </div>

                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/box34/plantilla_3.png
                        </div>
                        ...
                        <div data-name="moduleText">
                            <div data-name="top">
                                <p>
                                    <b>Vehicles Automatitzation Excel</b>
                                    <br>
                                    Update by license vehicle
                                    <br>
                                    Relation Database: One Client and multiple Vehicles
                                </p>
                            </div>
                        </div>

                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/box34/plantilla_4.png
                        </div>

                        <div data-name="moduleText">
                            <div data-name="top">
                                <p>
                                    <b>Superadmin Mechanical Workshop and Multiple Clients</b>
                                    <br>
                                    Managament relationship to see all process
                                    <br>
                                </p>
                            </div>
                        </div>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/box34/plantilla_5.png
                        </div>
                        ...
                        <div data-name="moduleText">
                            <div data-name="top">
                                <p>
                                    <b>Mechanical Workshop manage multiple clients and Multiple Vehicles</b>
                                    <br>
                                    Managament relationship to see all process
                                    <br>
                                </p>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/box34/plantilla_6.png
                        </div>

                        <div data-name="moduleText">
                            <div data-name="top">
                                <p>
                                    <b>Incidence process</b>
                                    <br>
                                    Client open an Incidence about vehicles
                                    <br>
                                    Mechanical Workshop see an Incidence by Panel and Email
                                    <br>
                                    Mechanical Workshop change status incidence
                                    <br>
                                    Five status incidence by email and panel
                                    <br>
                                </p>
                            </div>
                        </div>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/box34/plantilla_7.png
                        </div>
                        ...
                        <div data-name="moduleText">
                            <div data-name="top">
                                <p>
                                    <b>Browse Incidence datatable</b>
                                    <br>
                                    Look for license vehicles
                                    <br>
                                </p>
                            </div>
                        </div>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/box34/plantilla_8.png
                        </div>

                        <div data-name="moduleText">
                            <div data-name="top">
                                <p>
                                    <b>All incidence by Chalendar</b>
                                    <br>
                                    Select date and time and send by email
                                    <br>
                                </p>
                            </div>
                        </div>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/box34/plantilla_9.png
                        </div>
                        ...
                        <div data-name="moduleText">
                            <div data-name="top">
                                <p>
                                    <b>Send emails</b>
                                    <br>
                                    Send email detail incidence with all vehciles and problems
                                    <br>
                                    Send email detail incidence to change status incidence
                                    <br>
                                </p>
                            </div>
                        </div>
                ...
                <div data-path='pisosenmanresa' data-template="case-0">
                  ...
                  <div data-name="info">
                      ...
                      <div data-name="website"><a target="_blank" href="https://www.pisosenmanresa.com">PisosEnManresa</a></div>
                  </div>

                  <div data-name="overviewimage">
                      <?php echo $url; ?>upload/pisosenmanresa/plantilla_imagen_1.png                    
                  </div>
                  ...
                  <div data-name="home">
                      ...
                      <div data-name="details">
                          <div>
                          <br />
                          Server Languages:&nbsp; PHP, Symfony, CodeIgniter<br />
                          Client Languages: Javascript, jQuuery<br />
                          Database:&nbsp; MySQL<br />
                          Animations:&nbsp; Tween<br />
                          Credits: <b>PisosEnManresa</b><br>
                          Website: <a target="_blank" href="https://www.pisosenmanresa.com">https://www.pisosenmanresa.com</a> 
                         </div>
                      </div>
                      <div data-name="body">
                          <p><b>eCommerce real estate&nbsp;</b>to show property business, users properties and contact with visitors</p>
                      </div>
                  </div>
                  <!-- home -->
                ...
                <div data-name="modules">
                      ...
                      <div data-name="moduleImage" width="1920" height="1080">
                          <?php echo $url; ?>upload/pisosenmanresa/plantilla_imagen_2.png 
                      </div>
                      ...
                      <div data-name="moduleText">
                          <div data-name="top">
                              ...
                              Cache Pages
                              <br>
                              Session characteristic results
                              <br>
                              Big paginators
                           </div>
                      </div>
                      <div data-name="moduleImage" width="1920" height="1080">
                          <?php echo $url; ?>upload/pisosenmanresa/plantilla_imagen_3.png 
                      </div>
                      ...
                      <div data-name="moduleImage" width="1920" height="1080">
                          <?php echo $url; ?>upload/pisosenmanresa/plantilla_imagen_4.png
                      </div>
                      <div data-name="moduleText">
                           <div data-name="top">
                              <p>
                      ...
                      <div data-name="moduleImage" width="1920" height="1080">
                          <?php echo $url; ?>upload/pisosenmanresa/plantilla_imagen_5.png
                      </div>
                      <div data-name="moduleText">
                           <div data-name="top">
                              <p>
                                 <b>PisosEnManresa</b>
                                  ...
                                  <br>
                                  Contact users with business and all together                               
                                  </p>
                            </div>
                      </div>
                      <div data-name="moduleImage" width="1920" height="1080">
                          <?php echo $url; ?>upload/pisosenmanresa/plantilla_imagen_6.png
                      </div>
                      <div data-name="moduleText">
                           <div data-name="top">
                              <p>
                      ...
                      <div data-name="moduleImage" width="1920" height="1080">
                          <?php echo $url; ?>upload/pisosenmanresa/plantilla_imagen_7.png
                      </div>
                      <div data-name="moduleText">
                           <div data-name="top">
                              <p>
                      ...
                      <div data-name="moduleImage" width="1920" height="1080">
                          <?php echo $url; ?>upload/pisosenmanresa/plantilla_imagen_10.png
                      </div>
                      <div data-name="moduleText">
                           <div data-name="top">
                              <p>
                      ...
                      <div data-name="moduleImage" width="1920" height="1080">
                          <?php echo $url; ?>upload/pisosenmanresa/plantilla_imagen_12.png
                      </div>
                      <div data-name="moduleText">
                           <div data-name="top">
                              <p>
                      ...
                      <div data-name="moduleImage" width="1920" height="1080">
                          <?php echo $url; ?>upload/pisosenmanresa/plantilla_imagen_13.png
                      </div>
                      <div data-name="moduleText">
                           <div data-name="top">
                              <p>
             ...
             <!-- case 0 --> 
               ...
               <div data-path='hostalparisbcnstienda' data-template="case-0">
                  <!-- <div data-path='royalpasseigdegraciahotel' data-template="case-0"> -->
                    <div data-name="info">
                        <div data-name="headline">
                            Hostal Paris Barcelona 
                    ...
                    <div data-name="home">
                        ...
                        <div data-name="details">
                            <div><br />
                            Server Languages:Php Prestashop<br />
                            Client Languages: Javascript, jQuuery<br />
                            Database:Mysql<br />
                            Animations:JavaScript<br />
                            Credits: <b>Hostal Paris Barcelona</b>
                            <br>
                            Website:<a href="https://www.davidberruezo.com/hostalparisbcn/hotel">https://www.davidberruezo.com/hostalparisbcn/hotel</a>
                            </div>
                        </div>
                        <div data-name="body">
                            <p><b>Hostal Paris Barcelona:&nbsp;</b><br>Prestashop store, rooms as products, mirai reservation system</p>
                        </div>
                    </div>
                    <!-- home -->
                  <div data-name="modules">
                        ...
                        <div data-name="moduleText">
                            <div data-name="top">
                                ...
                                <b>Hostal Paris Barcelona</b>
                                <br>
                                slide show to show all images 
                                </p>
                            </div>
                        </div>
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/hostalparisbcn_tienda/plantilla_imagen_2.png 
                        </div>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/hostalparisbcn_tienda/plantilla_imagen_3.png 
                        </div>
                        <div data-name="moduleText">
                            <div data-name="top">
                                <p>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/hostalparisbcn_tienda/plantilla_imagen_4.png
                        </div>
                        <div data-name="moduleText">
                            <div data-name="top">
                                <p>
                                    ...
                                    Reservation System
                                    <br> 
                                    Mirai reservation system
                                    <br>  
                                    Sending variables configuration to Mirai
                                    <br>
                                    Making css to Mirai
                                 </p>
                              </div>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/hostalparisbcn_tienda/plantilla_imagen_5.png
                        </div>
                        <div data-name="moduleText">
                            <div data-name="top">
                                <p>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/hostalparisbcn_tienda/plantilla_imagen_6.png
                        </div>
                        <div data-name="moduleText">
                            <div data-name="top">
                                <p>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/hostalparisbcn_tienda/plantilla_imagen_7.png
                        </div>
                  </div>
                  <!-- modules -->
               </div>
               <!-- case 0 -->
               <div data-path='yourspanishwineslideshow' data-template="case-0">
                  <!-- <div data-path='royalpasseigdegraciahotel' data-template="case-0"> -->
                    <div data-name="info">
                        <div data-name="headline">
                            Your Spanish Wine SlideShow 
                        </div>
                        <div data-name="client">
                            eCommerce Barcelona                         
                        </div>
                    ...
                    <div data-name="home">
                        ...
                        <div data-name="details">
                            ...
                            Credits: <b>Hostal Paris Barcelona</b>
                            <br>
                            Website: <a target="_blank" href="https://davviddberruezo.com/yourspanishwine/html">https://davviddberruezo.com/yourspanishwine/html</a>
                           </div>
                        </div>
                        <div data-name="body">
                            <p><b>Your Spansh Wine Slide show</b>
                            <br>
                            JavaScript system to show all wine
                            <br> 
                            gallery in OOP js system
                            <br>
                            responsive native css and animation
                           </p>
                        </div>
                    </div>
                    <!-- home -->
                  <div data-name="modules">
                        ...
                        <div data-name="moduleText">
                            <div data-name="top">
                                <p>
                                   <b>Your Spanish Wine Slide show</b>
                                   <br>
                                   Interactive Scripts
                                   <br>
                                   Menu JavaScript
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/yourspanish_wine_slideshow/plantilla_imagen_2.png 
                        </div>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/yourspanish_wine_slideshow/plantilla_imagen_3.png 
                        </div>
                        
                        <div data-name="moduleText">
                            <div data-name="top">
                                 <p>
                                   <b>Your Spanish Wine Slideshow</b>
                                   <br> 
                                   Navigation system
                                 </p>
                            </div>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/yourspanish_wine_slideshow/plantilla_imagen_4.png 
                        </div>
                        <div data-name="moduleText">
                            <div data-name="top">
                            <p><b>Your Spansh Wine</b>
                            <br>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/yourspanish_wine_slideshow/plantilla_imagen_5.png
                        </div>
                  </div>
                  <!-- modules -->
               </div>
               <!-- case 0 -->
               <div data-path='yourspanishwinetienda' data-template="case-0">
                  <!-- <div data-path='royalpasseigdegraciahotel' data-template="case-0"> -->
                    <div data-name="info">
                        <div data-name="headline">
                            Your Spanish Wine Store 
                        </div>
                        <div data-name="client">
                            eCommerce Barcelona                         
                        </div>
                    ...
                    <div data-name="home">
                        <div data-name="headline">
                            Your Spansh Wine Store                        
                        </div>
                        <div data-name="details">
                            <div><br />
                            Server Languages:Prestashop PHP<br />
                            Client Languages: Javascript, jQuuery<br />
                            Database:MySQL<br />
                        ...
                        <div data-name="body">
                            <p>
                            <b>Your Spanish Wine Store</b>
                            <br>
                            Prestashop Store to sell wine
                            <br>
                            Programming template, layer module
                            <br>
                            characteristics wines, slide show, categories
                            <br> 
                           </p>
                        </div>
                    </div>
                  ...
                  <div data-name="modules">
                        ...
                        <div data-name="moduleText">
                            <div data-name="top">
                                <p>
                                 ...
                                 Products as wines
                                 <br>
                                 Categories as category wines 
                                </p>
                            </div>
                        </div>
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/yourspanish_wine_tienda/plantilla_imagen_2.png 
                        </div>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/yourspanish_wine_tienda/plantilla_imagen_3.png 
                        </div>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/yourspanish_wine_tienda/plantilla_imagen_4.png 
                        </div>
                        <div data-name="moduleText">
                            <div data-name="top">
                                <p>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/yourspanish_wine_tienda/plantilla_imagen_5.png
                        </div>
                  </div>
                  <!-- modules -->
               </div>
               ...
               <div data-path='2automocion' data-template="case-0">
                  <!-- <div data-path='royalpasseigdegraciahotel' data-template="case-0"> -->
                    <div data-name="info">
                        <div data-name="headline">
                            2automocion 
                        ...
                        <div data-name="website"><a target="_blank" href="http://2automocion.com">http://2automocion.com</a></div>
                    </div>
                    <div data-name="overviewimage">
                        <?php echo $url; ?>upload/2automocion/plantilla_1.png                    
                    </div>
                    <div data-name="home">
                        <div data-name="headline">
                            2automocion                        
                        ...
                        <div data-name="details">
                            ...
                            Credits: <b>Your Spanish Wine</b>
                            <br>
                            Website:<a href="http://2automocion.com">http://2automocion.com</a>
                            </div>
                        </div>
                        <div data-name="body">
                            <p>
                            <b>2automocion Store</b>
                            <br>
                            Prestashop store to sell car parts, in particular car mirrors.
                            <br>
                            .Net application to create excels and save car makes, car models 
                            <br>
                            and car mirrors.
                            <br> 
                           </p>
                  ...
                  <div data-name="modules">
                        ...
                        <div data-name="moduleText">
                            <div data-name="top">
                                <p>
                                 ...
                                 <br>
                                 Browse by car mirror
                                </p>
                            </div>
                        </div>
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/2automocion/plantilla_2.png 
                        </div>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/2automocion/plantilla_3.png 
                        </div>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/2automocion/plantilla_4.png 
                        </div>
                        <div data-name="moduleText">
                            <div data-name="top">
                                <p>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/2automocion/plantilla_5.png
                        </div>
                        <div data-name="moduleText">
                            <div data-name="top">
                                <p>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/2automocion/plantilla_6.png
                        </div>
                        <div data-name="moduleText">
                            <div data-name="top">
                                <p>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/2automocion/plantilla_7.png
                        </div>
                        <div data-name="moduleText">
                            <div data-name="top">
                                <p>
               ...
               <div data-path='davidberruezozend' data-template="case-0">
                  <!-- <div data-path='royalpasseigdegraciahotel' data-template="case-0"> -->
                    <div data-name="info">
                        <div data-name="headline">
                            David Berruezo Portfolio 
                        </div>
                        <div data-name="client">
                            eCommerce Barcelona                         
                        </div>
                        <div data-name="project">
                            Zend Framework Website ( Frontend )                        
                        </div>
                        <div data-name="year">
                            2012-September                        
                        </div>
                    ...
                    <div data-name="home">
                        ...
                        <div data-name="details">
                            <div><br />
                            Server Languages:PHP7<br />
                            Client Languages: JavaScript, jQuuery,Masonry jQuery Plugin<br />
                            Database:MySQL<br />
                        ...
                        <div data-name="body">
                            <p><b>David Berruezo Portfolio</b>
                            <br>
                            Zend Framework 2 Application to show portfolio with Mysql database
                            and use Zend TableGateway as ORM
                            </p>
                        </div>
                    </div>
                    <!-- home -->
                  <div data-name="modules">
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/david_berruezo_zend/plantilla_imagen_2.png 
                        </div>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/david_berruezo_zend/plantilla_imagen_3.png 
                        </div>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/david_berruezo_zend/plantilla_imagen_4.png 
                        </div>
                        <div data-name="moduleText">
                            <div data-name="top">
                                <p>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/david_berruezo_zend/plantilla_imagen_5.png
                        </div>
                        <div data-name="moduleText">
                            <div data-name="top">
                                <p>
                                ...
                                Css3 Animations 
                                <br>
                                JavaScript Tween Max Animation
                                </p>
                            </div>
                        </div>
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/david_berruezo_zend/plantilla_imagen_6.png
                        </div>
                        <div data-name="moduleText">
                            <div data-name="top">
                                <p>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/david_berruezo_zend/plantilla_imagen_7.png
                        </div>
               ...
               <!-- case 0 -->
               <div data-path='davidberruezozendintranet' data-template="case-0">
                  <!-- <div data-path='royalpasseigdegraciahotel' data-template="case-0"> -->
                    <div data-name="info">
                        <div data-name="headline">
                            David Berruezo Backend 
                        </div>
                        <div data-name="client">
                            eCommerce Barcelona                         
                        </div>
                    ...
                    <div data-name="home">
                        ...
                        <div data-name="details">
                            <div><br />
                            Server Languages:Php 7<br />
                            Client Languages: Javascript, jQuuery<br />
                            Database:MySQL<br />
                            Animations:Tween<br />
                            Php Framework: Zend Framework 2<br>
                            Website: <a target="_blank" href="https://davidberruezo.com/davidberruezo/login">https://davidberruezo.com/davidberruezo/login</a><br>
                        ...
                        <div data-name="body">
                            ...
                            <b>David Berruezo Backend</b>
                            <br>
                            Zend Framework 2 Application with MySQL database,
                            use TableGateway as ORM, Mysql relationship, CRUD,
                            system select,insert,delete,update 
                            </p>
                        </div>
                    </div>
                    <!-- home -->
                  <div data-name="modules">
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/david_berruezo_zend_intranet/plantilla_imagen_2.png 
                        </div>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/david_berruezo_zend_intranet/plantilla_imagen_3.png 
                        </div>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/david_berruezo_zend_intranet/plantilla_imagen_4.png 
                        </div>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/david_berruezo_zend_intranet/plantilla_imagen_5.png
                        </div>
                        <div data-name="moduleText">
                            <div data-name="top">
                                <p>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                            <?php echo $url; ?>upload/david_berruezo_zend_intranet/plantilla_imagen_6.png
                        </div>
               ...
               <!-- case 0 -->  
               <div data-path='davidberruezozendblog' data-template="case-0">
                  <!-- <div data-path='royalpasseigdegraciahotel' data-template="case-0"> -->
                    <div data-name="info">
                        <div data-name="headline">
                            David Berruezo Blog 
                        ...
                        <div data-name="project">
                            Wordpress blog ( Frontend / Backend )                        
                        </div>
                        <div data-name="year">
                            2012-September                        
                        </div>
                    ...
                    <div data-name="home">
                        ...
                        <div data-name="body">
                            <p>
                               <b>David Berruezo Blog</b>
                               <br>
                               Wordpress Child theme, shortcodes, scripts as defer,
                               bootstrap, pages and posts
                           </p>
                        </div>
                    </div>
                    <!-- home -->
                  <div data-name="modules">
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                           <?php echo $url; ?>upload/david_berruezo_zend_blog/plantilla_imagen_2.png 
                        </div>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                        <?php echo $url; ?>upload/david_berruezo_zend_blog/plantilla_imagen_3.png 
                        </div>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                        <?php echo $url; ?>upload/david_berruezo_zend_blog/plantilla_imagen_4.png
                        </div>
               ...
               <!-- case 0 -->   
               <div data-path='davidberruezoarticlesblog' data-template="case-0">
                  <!-- <div data-path='royalpasseigdegraciahotel' data-template="case-0"> -->
                    <div data-name="info">
                        <div data-name="headline">
                            David Berruezo Blog 
                        ...
                        <div data-name="website"><a target="_blank" href="https://www.davidberruezo.com/blog">https://www.davidberruezo.com/blog</a></div>
                    </div>
                    <div data-name="overviewimage">
                        <?php echo $url; ?>upload/david_berruezo_articles/plantilla_imagen_1.png                    
                    </div>
                    <div data-name="home">
                        <div data-name="headline">
                            David Berruezo Blog                        
                  ...
                  <div data-name="modules">
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                           <?php echo $url; ?>upload/david_berruezo_articles/plantilla_imagen_2.png 
                        </div>
               ...
               <!-- case 0 -->
               <div data-path='davidberruezoportfolio' data-template="case-0">
                  <!-- <div data-path='royalpasseigdegraciahotel' data-template="case-0"> -->
                    <div data-name="info">
                        <div data-name="headline">
                            Portfolio 
                        ...
                        <div data-name="project">
                            JavaScript Object Application ( Frontend / Backend )                        
                        </div>
                        <div data-name="year">
                            2012-September                        
                        </div>
                    ...
                    <div data-name="home">
                        ...
                        <div data-name="body">
                            <p>
                               <b>David Berruezo Portfolio</b>
                               <br>
                               JavaScript application using objects, contentManager,
                               dispatchEvents, Touch, Drags, Components, Tween animations
                           </p>
                        </div>
                    </div>
                    <!-- home -->
                  <div data-name="modules">
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                           <?php echo $url; ?>upload/david_berruezo_portfolio/plantilla_imagen_2.png 
                        </div>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                           <?php echo $url; ?>upload/david_berruezo_portfolio/plantilla_imagen_3.png 
                        </div>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                           <?php echo $url; ?>upload/david_berruezo_portfolio/plantilla_imagen_4.png 
                        </div>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                           <?php echo $url; ?>upload/david_berruezo_portfolio/plantilla_imagen_5.png 
                        </div>
               ...
               <div data-path='davidberruezoportfoliointranet' data-template="case-0">
                  <!-- <div data-path='royalpasseigdegraciahotel' data-template="case-0"> -->
                    <div data-name="info">
                        <div data-name="headline">
                            Portfolio Intranet
                        ...
                        <div data-name="project">
                            codeIgniter application ( Frontend / Backend )                        
                        </div>
                        <div data-name="year">
                            2012-September                        
                        </div>
                    ...
                    <div data-name="home">
                        ...
                        <div data-name="body">
                            <p>
                               <b>Portfolio Intranet</b>
                               <br>
                               codeIgniter application intranet, mvc system,
                               mysql relationships, upload images, dynamic pages,
                               dynamic projects, characteristics, all content
                            </p>
                        </div>
                    </div>
                    <!-- home -->
                  <div data-name="modules">
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                           <?php echo $url; ?>upload/david_berruezo_portfolio_intranet/plantilla_imagen_2.png 
                        </div>
                        ...
                        <div data-name="moduleText">
                            <div data-name="top">
                              <p>
                                ...
                                Dynamic pages  
                                <br>
                                Dynamic slug language and pages
                                <br>
                              </p>
                              </div>
                        </div>
                        <div data-name="moduleImage" width="1920" height="1080">
                           <?php echo $url; ?>upload/david_berruezo_portfolio_intranet/plantilla_imagen_3.png 
                        </div>
                        ...
                        <div data-name="moduleText">
                            ...
                            <p>
                                ...
                                Dynamic Projects  
                                <br>
                                Dynamic characteristics projects
                                <br>
                                Dynamc galleries
                                <br>
                                Dynamic categories
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                           <?php echo $url; ?>upload/david_berruezo_portfolio_intranet/plantilla_imagen_4.png 
                        </div>
                        ...
                        <div data-name="moduleImage" width="1920" height="1080">
                           <?php echo $url; ?>upload/david_berruezo_portfolio_intranet/plantilla_imagen_5.png 
                        </div>
